...
Verified 2026-07-28, on the proof as of that date, before the certificate layer moved to
Macaulean. (The certificate layer was switched to Macaulean's GMP-free
`algebra_norm_reflect` on 2026-08-26 and awaits a re-run, ideally on Lean ≥ 4.33.1 with
`enable_nanoda: true`.) Comparator accepted this solution:
